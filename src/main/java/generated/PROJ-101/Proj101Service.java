...
@Slf4j
@Transactional
public class Proj101Service {
    
    private final Proj101Repository repository;
    
    public List<Proj101> getAllStories() {
        log.info("Fetching all stories");
        return repository.findAll();
    }
    
    public Optional<Proj101> getStoryById(Long id) {
        log.info("Fetching story by id: {}", id);
        return repository.findById(id);
    }
    
    public Proj101 createStory(Proj101 story) {
    ...
    public Proj101 updateStory(Long id, Proj101 story) {
        log.info("Updating story: {}", id);
        Proj101 existing = repository.findById(id)
    ...
    public List<Proj101> getStoriesByPriority(String priority) {
